...
const Setting g_sim_settings[] = {
    // timing distortion
    { "rpmJitter",   "RPM jitter",    "hardware", Scope::SimOnly, ParamType::Int,
       0, 0, 200, 10, nullptr, 0,
       get_rpmJitter, set_rpmJitter, nullptr, nullptr, nullptr },
    { "hallJitterUs","Hall jitter µs","hardware", Scope::SimOnly, ParamType::Int,
       0, 0, 500, 1, nullptr, 0,
       get_hallJitter, set_hallJitter, nullptr, nullptr, nullptr },
    { "hallMissRate","Hall miss %",   "hardware", Scope::SimOnly, ParamType::Int,
       0, 0, 50, 1, nullptr, 0,
       get_hallMiss, set_hallMiss, nullptr, nullptr, nullptr },
    { "timerDrift",  "Timer drift ppm","hardware",Scope::SimOnly, ParamType::Int,
       0, 0, 1000, 1, nullptr, 0,
       get_timerDrift, set_timerDrift, nullptr, nullptr, nullptr },
    { "patternLag",  "Pattern lag ms","hardware", Scope::SimOnly, ParamType::Int,
       0, 0, 100, 1, nullptr, 0,
       get_patternLag, set_patternLag, nullptr, nullptr, nullptr },
    // playback
    { "displayHz",   "Display Hz",    "hardware", Scope::SimOnly, ParamType::Enum,
       60, 0, 240, 1, kDisplayHzOpts, 4,
       get_displayHz, set_displayHz, nullptr, nullptr, nullptr },
    { "simSpeed",    "Sim speed",     "hardware", Scope::SimOnly, ParamType::Int,
       10, 1, 50, 10, nullptr, 0,
       get_simSpeed, set_simSpeed, nullptr, nullptr, nullptr },
    // overlays
    { "showOverruns",   "Show overruns",    "hardware", Scope::SimOnly, ParamType::Bool,
       1, 0, 1, 1, nullptr, 0,
       get_showOverruns, set_showOverruns, nullptr, nullptr, nullptr },
    { "showSliceGrid",  "Show slice grid",  "hardware", Scope::SimOnly, ParamType::Bool,
       0, 0, 1, 1, nullptr, 0,
       get_showSliceGrid, set_showSliceGrid, nullptr, nullptr, nullptr },
    { "showHallMarker", "Show hall marker", "hardware", Scope::SimOnly, ParamType::Bool,
       1, 0, 1, 1, nullptr, 0,
